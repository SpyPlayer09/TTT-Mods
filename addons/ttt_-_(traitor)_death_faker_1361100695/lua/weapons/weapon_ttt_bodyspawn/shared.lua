...
if SERVER then
  ...
  resource.AddFile("materials/vgui/ttt/icon_death_faker.png")
end
...
if CLIENT then
   ...
   SWEP.EquipMenuData = {
      type  = "item_weapon",
      name  = "Death Faker",
      desc  = "Spawns a dead body.\n Rightclick to place blood, reload to change weapon, name and role"
   };

   SWEP.Icon = "vgui/ttt/icon_death_faker.png"
